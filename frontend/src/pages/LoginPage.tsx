    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-white/50 text-sm mt-1">Your Intelligent AI Assistant</p>
        </div>
        ...
        <div className="glass rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input className="input-base pl-10 pr-10" type={showPass ? 'text' : 'password'}
          ...
          <div className="mt-5">
            ...
            <div className="flex gap-3">
              <button onClick={() => authApi.googleLogin()}
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-sm transition-all">
